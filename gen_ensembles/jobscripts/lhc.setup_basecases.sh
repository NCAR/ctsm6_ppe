#!/bin/bash
# create base cases for ctsm5.3.010 

# ===============================================
# setup

tag_dir="/glade/work/linnia/ctsm5.3.010"
chargenum='P93300641'

source ~/.bashrc

USER_MODS_DIR='/glade/u/home/linnia/ctsm6_ppe/gen_ensembles/jobscripts/lhc_user_mods'
LND_MESH_FILE=${USER_MODS_DIR}/lnd_mesh.nc

paramfile='/glade/work/linnia/ctsm5.3.010/cime/scripts/transient/runtime_files/ctsm5.3.010_params.default.c241111.nc'
...
casedir="/glade/work/linnia/ctsm5.3.010/cime/scripts/transient/basecases/"
case="ctsm5.3.010_transient"
