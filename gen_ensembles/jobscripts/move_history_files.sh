...
ens_list=`ls -d BNF_v2.n01_ctsm5.3.012_transient_lhc*`
...
do
    ...
    cp BNF_v2.n01_ctsm5.3.012_transient_lhc*.clm2.h*.2015-01-01* $hist_dir
    cp BNF_v2.n01_ctsm5.3.012_transient_lhc*.clm2.h*.2020-01-01* $hist_dir
    cp BNF_v2.n01_ctsm5.3.012_transient_lhc*.clm2.h*.2015-02-01* $hist_dir
    cp BNF_v2.n01_ctsm5.3.012_transient_lhc*.clm2.h*.2020-02-01* $hist_dir
